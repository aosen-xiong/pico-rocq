(** Salvaged potential-graph call-pop machinery.
    ...
    Kept here are the symmetry-free RDM call-pop merge lemmas, whose
    combinator [classified_rdm_call_pop_merge_safe] reduces the whole
    RDM-destination pop obligation to the single [Imm_r] /
    covariant-[Mut] return case, together with the two-sided partition
    invariant that discharges that residual case. *)
