  ...
  -
    ...
    --  
      ...
      assert (Hneq: anyf <> f).
      {
        intro Heq.
        subst anyf.
        unfold sf_assignability_rel in H15, Hfinal.
        destruct H15 as [fdef_assign [Hlookup_assign Hassign_assign]].
    ...
    -- (* RDA case: RDA fields cannot be written *)
      ...
      assert (Hneq: anyf <> f).
      {
        intro Heq.
        subst anyf.
        unfold sf_assignability_rel in H15, Hrda.
        destruct H15 as [fdef_assign [Hlookup_assign Hassign_assign]].
