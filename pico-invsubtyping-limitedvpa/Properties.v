...
Lemma method_body_well_typed : forall CT mt C cdef mdef,
  wf_class_table CT ->
  C < dom CT ->
  find_class CT C = Some cdef ->
  In mdef (methods (body cdef)) ->
  mt = mdef.(msignature).(mtype) ->
  exists sΓ', stmt_typing CT mt (mreceiver (msignature mdef) :: mparams (msignature mdef)) 
                           (mbody_stmt (mbody mdef)) 
                           sΓ'.
Proof.
  intros CT mt C cdef mdef Hwf_ct Hdom HfindC Hlookup Hmt_eq.
...
Lemma method_body_well_typed_by_find : forall CT mt C m mdef,
  wf_class_table CT ->
  C < dom CT ->
  ...
  exists sΓ', stmt_typing CT mt (mreceiver (msignature mdef) :: mparams (msignature mdef)) 
                           ...
                           sΓ'.
Proof.
  intros CT mt C m mdef Hwf_ct Hdom Hlookup Hmt_eq.
  assert (Hexists_class : exists class_def, find_class CT C = Some class_def).
  {
    apply find_class_Some.
    exact Hdom.
...
Proof.
  ...
  destruct T1 as [ab1 q1 c1].
  destruct T2 as [ab2 q2 c2].
  simpl.
...
Proof.
  intros T1 T2.
  destruct T1 as [ab1 q1 c1], T2 as [ab2 q2 c2].
  unfold vpa_mutabilty_tt, vpa_mutabilty_qq.
  simpl.
...
Lemma preservation_skip :
  forall CT mt sΓ rΓ h sΓ',
    stmt_typing CT mt sΓ SSkip sΓ' ->
    wf_r_config CT sΓ rΓ h ->
    wf_r_config CT sΓ' rΓ h.
Proof.
  intros CT mt sΓ rΓ h sΓ' Htyping Hwf.
  inversion Htyping; subst; exact Hwf.
Qed.

Lemma preservation_local_ok :
  forall CT mt sΓ rΓ h T x sΓ',
    OK = OK ->
    wf_r_config CT sΓ rΓ h ->
    stmt_typing CT mt sΓ (SLocal T x) sΓ' ->
    runtime_getVal rΓ x = None ->
    wf_r_config CT sΓ' (rΓ <| vars := vars rΓ ++ [Null_a] |>) h.
Proof.
    intros CT mt sΓ rΓ h T rΓ' h' sΓ' Hwf Htyping Heval.
...
Lemma preservation_fldwrite_ok :
  forall CT mt sΓ rΓ h x f y loc_x o vf val_y h' sΓ',
    OK = OK ->
    wf_r_config CT sΓ rΓ h ->
    stmt_typing CT mt sΓ (SFldWrite x f y) sΓ' ->
    ...
    wf_r_config CT sΓ' rΓ h'.
Proof.
    intros CT mt sΓ rΓ h x f y loc_x o vf val_y h' sΓ'.
            ...
            --- split.
              ...
              +++ 
              {
                ...
                2:{
                  ...
                  split.
                    ...
                    unfold vpa_mutabilty_rec_fld; unfold vpa_mutabilty_stype_fld in H14.
                    subst rqt_x.

                    clear - H14 Hqual_typable Hxyqualifer.
                    all: destruct (rqtype (rt_type o)) eqn: rq;
                    destruct (mutability (ftype fieldT)) eqn: HfieldMut;
                    simpl;
                    simpl in H14; try trivial.
                    all: 
              ...
              - (* loc_y exists in original heap *)
                ...
                + (* Qualifier typable *)
                  ...
                  unfold vpa_mutabilty_stype_fld in H14.
                  unfold vpa_mutabilty_rec_fld.
                  unfold vpa_mutabilty_rs in Hqual_y.
                  clear - Hqual_y H14 Hqualifiertypablex.
                  all:
            ...
            --- split.
              ...
              +++ 
              {
                ...
                2:{
                  ...
                  split.
                    ...
                    move H13 at bottom.
                    move Hqual_typable at bottom.
                    unfold vpa_mutabilty_rec_fld; unfold vpa_mutabilty_stype_fld in H13.
                    subst rqt_x.

                    clear - H13 Hqual_typable Hxyqualifer.
                    all: destruct (rqtype (rt_type o)) eqn: rq;
                    destruct (mutability (ftype fieldT)) eqn: HfieldMut;
                    simpl;
                    simpl in H13; try trivial.
                    all: 
                    destruct (sqtype Tx) eqn: qx;
                    destruct (sqtype Ty) eqn: qy;
                    simpl in H13;
              ...
              - (* loc_y exists in original heap *)
                ...
                + (* Qualifier typable *)
                  ...
                  destruct Hcorr as [_ Hqualifiertypablex].
                  inversion Hgetobj; subst o.
                  unfold vpa_mutabilty_stype_fld in H13.
                  unfold vpa_mutabilty_rec_fld.
                  unfold vpa_mutabilty_rs in Hqual_y.
                  clear - Hqual_y H13 Hqualifiertypablex.
                  all:
                  destruct (rqtype rqt_y) eqn: Hrqy;
                  destruct (rqtype (rt_type o_x)) eqn: Hrqx;
                  destruct (mutability (ftype fieldT)) eqn: Hfield;
...
Lemma preservation_new_ok :
  forall CT mt sΓ rΓ h x q_c c ys l1 qthisr vals o qadapted rΓ' h' sΓ',
    OK = OK ->
    wf_r_config CT sΓ rΓ h ->
    stmt_typing CT mt sΓ (SNew x q_c c ys) sΓ' ->
    ...
    wf_r_config CT sΓ' rΓ' h'.
Proof.
  intros CT mt sΓ rΓ h x q_c c ys l1 qthisr vals o qadapted rΓ' h' sΓ'.
  intros HOK Hwf Htyping Hgetthis Hlookupvals HgetthisRuntimeType Hmutadapted Heq_o Heq_h' Heq_rΓ'.
    ...
    * (* ι = dom h (new object) *)
      ...
      -- (* wf_rtypeuse for new object *)
        ...
        ++ unfold constructor_def_lookup in H11.
     ...
     * (* Forall2 property *)
      ...
      destruct H as [qcontext Hreceivermut].
       ...
       simpl.
        ...
        exact Hparamtype.
        exact Habs.
        apply qualified_type_subtype_base_subtype in Hnonabs_case.
        eapply Forall2_nth_error with (i:=i) (b:=paramtype) (a:=argtype) in H14.
        apply qualified_type_subtype_base_subtype in H14.
        eapply base_trans; eauto.
        eapply base_trans; eauto.
        ...
        + 
          destruct Hlookupvals as [Hrctype Hqctype].
            ...
            3: exact Hfdef.
            1:{
              apply qualified_type_subtype_q_subtype in Habs_case.
              eapply Forall2_nth_error with (i:=i) (b:=paramtype) (a:=argtype) in H14.
              2: exact Hargtype.
              2: exact Hparamtype.
              2: exact Habs.
              ...
              unfold qualifier_typable_heap.
              unfold vpa_mutabilty_rec_fld.
              unfold vpa_mutabilty_constructor_fld in Habs_case.
              unfold vpa_mutabilty_object_creation.
              unfold qc2q in H14.
              simpl in H14.
              assert (l1 = ι). {
              ...
              subst qthisr.
              clear - Habs_case Habs Hqctype H14.
            ...
            1:{
              apply qualified_type_subtype_q_subtype in Hnonabs_case.
              eapply Forall2_nth_error with (i:=i) (b:=paramtype) (a:=argtype) in H14.
              2: exact Hargtype.
              2: exact Hparamtype.
              2: exact Hnonabs.
              ...
              subst qthisr.
              clear - Hnonabs_case Hnonabs Hqctype H14.
              destruct (rqtype rqt) eqn: Hrqtq;
              destruct qcontext eqn: Hqthis;
              destruct (cqualifier consig) eqn: Hconstructoreturnq;
              destruct (mutability (ftype fdef)) eqn: Hfieldq; 
              simpl in Hnonabs_case;
              try easy.
              all: destruct (sqtype paramtype) eqn: Hparamq;
              try solve_q_subtype_wrong.
              all: 
...
qthisr (cqualifier consig); rctype := c |}; fields_map := vals |}]) = dom h + 1).
    ...
    + destruct Hsenv as [HsenvLength HsenvWellTyped]. rewrite <- H12. exact HsenvLength.
    + destruct Hsenv as [HsenvLength HsenvWellTyped]. rewrite <- H12. exact HsenvWellTyped.
...
Proof.
  ...
  6:
    {
      ...
      { (* Method inner config wellformed.*)
        ...
        split.
          ...
          subst objy.
          simpl in *.
          destruct H24 as [H24 | HspecialCase].
          apply qualified_type_subtype_base_subtype in H24.
          rewrite (vpa_mutabilty_tt_sctype Ty (mreceiver (msignature mdef))) in H24.
          eapply base_trans; eauto.
          ...
          1:
          {
            ...
            -
            destruct HspecialCase as [HReceiverMutability[HCallerMutability [Hbasesubtype Habssubtype]]].
            clear - Houtterqualifier HInnerReceiverQualifier HReceiverMutability HCallerMutability.
            destruct (rqtype (rt_type objy)) eqn:Hrqtq;
            destruct (sqtype (mreceiver (msignature mdef0))) eqn:Hreceiverq;
            try solve_qualifier_typable_correct_concrete.
            all: try discriminate HReceiverMutability.
        }
  ...
  (* -------------------------------------------------- *)
        ...
        - (* Parameter i' exists *)
          ...
          rewrite (vpa_mutabilty_tt_sctype Ty) in H25.
          eapply base_trans; eauto.
          ...
          --
            ...
            rewrite sq_vpa_tt_eq_qq in H25.
          ...
          --
            destruct HspecialCase as [HReceiverMutability[HCallerMutability [Hbasesubtype Habssubtype]]].
            clear - H25 Harg_qual_subtype Houtterqualifier HInnerReceiverQualifier HReceiverMutability HCallerMutability.
            rewrite sq_vpa_tt_eq_qq in H25.
            unfold vpa_mutabilty_qq in H25.
            destruct (rqtype (rt_type obj_loc)) eqn:HArgMutability;
            destruct (rqtype (rt_type objι)) eqn:HInnerReceiverMutability;
            destruct (sqtype sqt) eqn:HParameterStaticDeclearedMutability;
            try solve_qualifier_typable_correct_concrete.
            ...
            destruct (sqtype Ty) eqn:HyStaticMutability;
            try solve_qualifier_typable_wrong_concrete.
            all: try discriminate HCallerMutability.
            all:
            destruct (sqtype argtype) eqn:Hargqtype;
            try solve_qualifier_typable_wrong_concrete.
            all: destruct (sqtype Tthis) eqn:HOutterReceiverStaticMutability;
        ...
        - (* Case: i = x (updated variable) *)
          ...
          + (* Show wf_r_typable for retval *)
            ...
            2:{
              ...
              rewrite (vpa_mutabilty_tt_sctype Ty (mret (msignature mdef0))) in H23.
              ...
              clear - Hsubtype_ret H23 HReceiverMutability HCallerMutability HyQualifierTypablility HOutterReceiverQualifierTypablility Hrorettypequalifier.
              destruct (rqtype (rt_type o)) eqn:HretObjectMutability; move HretObjectMutability at bottom;
              destruct (rqtype (rt_type outterreceiverobj)) eqn:HOutterReceiverRuntimeMutability; move HOutterReceiverRuntimeMutability at bottom;
              destruct (sqtype Tx) eqn:HTxStaticMutability; move HTxStaticMutability at bottom;
              try solve_qualifier_typable_correct_concrete.
      ...
      { 
        ...
        destruct H24 as [H24 | HspecialCase].
        apply qualified_type_subtype_base_subtype in H24.
        rewrite (vpa_mutabilty_tt_sctype Ty (mreceiver (msignature mdef0))) in H24.
        eapply base_trans; eauto.
        destruct HspecialCase as [HReceiverMutability[HCallerMutability [Hreceiverbasesubtype Habssubtype]]].
        eapply base_trans; eauto.
        ...
        1: 
        {
          ...
          unfold vpa_mutabilty_tt in H24.
  ...
  (* Other index - > 1 *)
        ...
        destruct (nth_error vals i') as [v|] eqn:Hval_i.
          - (* Parameter i' exists *)
            ...
            eapply Forall2_nth_error in H25; eauto.
            apply qualified_type_subtype_base_subtype in H25.
            rewrite (vpa_mutabilty_tt_sctype Ty sqt) in H25.
            eapply base_trans; eauto.
        ...
        - (* Case: i = x (updated variable) *)
          ...
          + (* Show wf_r_typable for retval *)
            ...
            2:{
              ...
              destruct HspecialCase as [HReceiverMutability[HCallerMutability [Hreceiverbasesubtype Habssubtype]]].
              rewrite <- Hmsigeq in H23.
              clear - Hrorettypequalifier H23 Houtter_qualifier_typable Hsubtype_ret HReceiverMutability HCallerMutability HyQualifierTypability.
              rewrite sq_vpa_tt_eq_qq in H23.
              destruct (rqtype (rt_type retobj)) eqn:Hrorettypemutability; move Hrorettypequalifier at bottom;
              destruct (rqtype (rt_type outterreceiverobj)) eqn:HOutterReceiverMutabilityValue; move HOutterReceiverMutabilityValue at bottom;
              destruct (sqtype Tx) eqn:HTxStaticMutability; move HTxStaticMutability at bottom;
      ...
      { (* Method inner config wellformed.*)
        ...
        split.
          ...
          destruct H25 as [H25 | HspecialCase].
          apply qualified_type_subtype_base_subtype in H25.
          rewrite (vpa_mutabilty_tt_sctype Ty (mreceiver (msignature mdef))) in H25.
          eapply base_trans; eauto.
          destruct HspecialCase as [HReceiverMutability[HCallerMutability [Hreceiverbasesubtype Habssubtype]]].
          eapply base_trans; eauto.
        ...
        1:
        {
          ...
          apply qualified_type_subtype_q_subtype in H25.
          rewrite sq_vpa_tt_eq_qq in H25.
          clear - Houtterqualifier HInnerReceiverQualifier H25.
          destruct (rqtype (rt_type objy)) eqn:Hrqtq;
          destruct (sqtype (mreceiver (msignature mdef0))) eqn:Hreceiverq;
          try solve_qualifier_typable_correct_concrete.
          all: destruct (sqtype Ty) eqn:Htyq;
  ...
  (* -------------------------------------------------- *)
        ...
        - (* Parameter i' exists *)
          ...
          (* apply qualified_type_subtype_q_subtype in H2. *)
          clear - Harg_qual_subtype Houtterqualifier HInnerReceiverQualifier H26.
          rewrite sq_vpa_tt_eq_qq in H26.
          destruct (rqtype (rt_type obj_loc)) eqn:HArgMutability;
          destruct (rqtype (rt_type objι)) eqn:HInnerReceiverMutability;
          destruct (sqtype sqt) eqn:HParameterStaticDeclearedMutability;
          try solve_qualifier_typable_correct_concrete.
        ...
        - (* Case: i = x (updated variable) *)
          ...
          + (* Show wf_r_typable for retval *)
            ...
            2:{
              ...
              (* rewrite (vpa_mutabilty_tt_sctype Tthis Tx) in H22. *)
              (* rewrite (vpa_mutabilty_tt Ty (mret (msignature mdef0))) in H22. *)
              rewrite (vpa_mutabilty_tt_sctype Ty (mret (msignature mdef0))) in H24.
              (* rewrite (vpa_mutabilty_tt_sctype (mreceiver (msignature mdef)) mrettype) in Hsubtype_ret.
              rewrite (vpa_mutabilty_tt_sctype (mreceiver (msignature mdef)) (mret (msignature mdef))) in Hsubtype_ret. *)
              rewrite <- Hmsigeq in H24.
              eapply base_trans; eauto.
              ...
              clear - Hsubtype_ret H24 H25 HyQualifierTypablility HOutterReceiverQualifierTypablility Hrorettypequalifier.
              destruct (rqtype (rt_type o)) eqn:HretObjectMutability; move HretObjectMutability at bottom;
              destruct (rqtype (rt_type outterreceiverobj)) eqn:HOutterReceiverRuntimeMutability; move HOutterReceiverRuntimeMutability at bottom;
              destruct (sqtype Tx) eqn:HTxStaticMutability; move HTxStaticMutability at bottom;
              try solve_qualifier_typable_correct_concrete.
              ...
              clear - Hsubtype_ret H24 HReceiverMutability HCallerMutability  HyQualifierTypablility HOutterReceiverQualifierTypablility Hrorettypequalifier.
              destruct (rqtype (rt_type o)) eqn:HretObjectMutability; move HretObjectMutability at bottom;
              destruct (rqtype (rt_type outterreceiverobj)) eqn:HOutterReceiverRuntimeMutability; move HOutterReceiverRuntimeMutability at bottom;
              destruct (sqtype Tx) eqn:HTxStaticMutability; move HTxStaticMutability at bottom;
              try solve_qualifier_typable_correct_concrete.
      ...
      { 
        ...
        destruct H25 as [H25 | HspecialCase].
        apply qualified_type_subtype_base_subtype in H25.
        rewrite (vpa_mutabilty_tt_sctype Ty (mreceiver (msignature mdef0))) in H25.
        eapply base_trans; eauto.
        destruct HspecialCase as [HReceiverMutability[HCallerMutability [Hreceiverbasesubtype Habssubtype]]].
        eapply base_trans; eauto.
        ...
        1: 
        {
          ...
          --
          apply qualified_type_subtype_q_subtype in H25.
          unfold vpa_mutabilty_tt in H25.
          ...
          try trivial.
          all: destruct (sqtype Tthis) eqn:HTthisStaticMutability;
          try rewrite HTyStaticMutability in H25;
          simpl in H25;
          try rewrite HMethodReceiverDeclaredType in H25;
          try inversion H25; try trivial.
          all: try inversion H25; try easy.
          --
          rewrite Hmsigeq.
          destruct HspecialCase as [HReceiverMutability[HCallerMutability [Hreceiverbasesubtype Habssubtype]]].
          destruct qinner eqn:HInnerReceiverMutability;
  ...
  (* Other index - > 1 *)
        ...
        destruct (nth_error vals i') as [v|] eqn:Hval_i.
          - (* Parameter i' exists *)
            ...
            eapply Forall2_nth_error in H26; eauto.
            apply qualified_type_subtype_base_subtype in H26.
            rewrite (vpa_mutabilty_tt_sctype Ty sqt) in H26.
            eapply base_trans; eauto.
        ...
        - (* Case: i = x (updated variable) *)
          ...
          + (* Show wf_r_typable for retval *)
            ...
            2:{
              ...
              clear - Hrorettypequalifier H24 Houtter_qualifier_typable Hsubtype_ret H25 HyQualifierTypability.
              rewrite sq_vpa_tt_eq_qq in H24.
              rewrite sq_vpa_tt_eq_qq in H25.
              destruct (rqtype (rt_type retobj)) eqn:Hrorettypemutability; move Hrorettypequalifier at bottom;
              destruct (rqtype (rt_type outterreceiverobj)) eqn:HOutterReceiverMutabilityValue; move HOutterReceiverMutabilityValue at bottom;
              ...
              destruct HspecialCase as [HReceiverMutability [HCallerMutability [Hreceiverbasesubtype Habssubtype]]].
              rewrite <- Hmsigeq in H24.
              rewrite <- Hmsigeq in HReceiverMutability.

              clear - Hrorettypequalifier H24 Houtter_qualifier_typable Hsubtype_ret HReceiverMutability HCallerMutability HyQualifierTypability.
              rewrite sq_vpa_tt_eq_qq in H24.
              destruct (rqtype (rt_type retobj)) eqn:Hrorettypemutability; move Hrorettypequalifier at bottom;
              destruct (rqtype (rt_type outterreceiverobj)) eqn:HOutterReceiverMutabilityValue; move HOutterReceiverMutabilityValue at bottom;
              destruct (sqtype Tx) eqn:HTxStaticMutability; move HTxStaticMutability at bottom;
