...
Lemma mutable_connected_after_null_field_update_is_old :
  forall CT h lx old f l1 l2,
    runtime_getObj h lx = Some old ->
    mutable_connected CT (update_field h lx f Null_a) l1 l2 ->
    mutable_connected CT h l1 l2.
Proof.
  intros CT h lx old f l1 l2 Hobj Hconnected.
  destruct (mutable_connected_after_field_update CT h lx old f Null_a
